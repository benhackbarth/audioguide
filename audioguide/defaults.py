...
DESCRIPTOR_WIN_SIZE_SEC = 0.04643990929708 # ~2048 @ 44.1 kHz
DESCRIPTOR_HOP_SIZE_SEC = 0.01160997732427 # overlap, this effectively sets the temporal resolution of audioguide
# ircamdescriptor
IRCAMDESCRIPTOR_RESAMPLE_RATE = 12500 # 12500 = ircam's default value
...
TARGET_SEGMENT_LABELS_FILEPATH = 'output/tgtLabels.txt'
