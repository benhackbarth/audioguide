...
class parseOptions:
	...
	def checkOptionsVariableTypes(self, ops):		
		# string or None
		for attr in ['TARGET_DESCRIPTORS_FILEPATH', 'DICT_OUTPUT_FILEPATH', 'ORDER_CORPUS_BY_DESCRIPTOR_FILEPATH', 'TARGET_OFFLINE_SEGMENTAITON_FILEPATH', 'MAXMSP_OUTPUT_FILEPATH', 'SUPERIMPOSITION_LABEL_FILEPATH', 'CSOUND_RENDER_FILEPATH', 'LOG_FILEPATH', 'MIDI_FILEPATH', 'LISP_OUTPUT_FILEPATH', 'TARGET_SEGMENTATION_GRAPH_FILEPATH', 'DATA_FROM_SEGMENTATION_FILEPATH', 'TARGET_PLOT_DESCRIPTORS_FILEPATH', 'TARGET_SEGMENT_LABELS_FILEPATH', 'CSOUND_CSD_FILEPATH', 'PM2_BIN', 'SUPERVP_BIN']:
