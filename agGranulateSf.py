...
parser.add_option("-g", "--grainlength", action="store", dest="GRAINLENGTH", type="float", help="set the threshold for detecting segment onsets.  a value from -100 to 0 where a lower value make onsets happen more frequently.  default=0.3")
parser.add_option("-o", "--grainoverlap", action="store", dest="GRAINHOP", type="float", help="set the threshold for detecting segment onsets.  a value from -100 to 0 where a lower value make onsets happen more frequently.  default=0.1")
